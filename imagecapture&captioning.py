...
# Streamlit UI
st.title("📸 Image-Capture & Captioning")
st.write("Capture an image from your webcam and ask multiple questions about it.")
...
if image_file is not None:
    ...
    st.image(raw_image, caption="Captured Image", use_column_width=True)
